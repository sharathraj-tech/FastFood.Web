...
using FastFood.Web.Models.ViewModels;
...
namespace FastFood.Web.Areas.Admin.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        {
            var listOfData = _context.Categories.ToList().Select(x => new CategoryViewModel()
            {
                Id = x.Id,
                Title = x.Title,
            }).ToList();
        ...
        public IActionResult Create(CategoryViewModel categoryViewModel)
        {
            ...
            model.Title = categoryViewModel.Title;
        ...
        public IActionResult Edit(CategoryViewModel categoryViewModel)
        {
            ...
            {
                var categoryFromDb = _context.Categories.FirstOrDefault(x => x.Id == categoryViewModel.Id);
                if (categoryFromDb != null)
                {
                    categoryFromDb.Title = categoryViewModel.Title;
